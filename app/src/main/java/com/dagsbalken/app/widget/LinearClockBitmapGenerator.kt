...
object LinearClockBitmapGenerator {
    ...
    fun generate(
        ...
        // Bolt Optimization: Pre-calculate pixelsPerMinute to use multiplication instead of division in loops
        ...
        for (i in events.indices) {
            ...
            // Bolt Optimization: Avoid unnecessary property access and math if end time is null
            val actualEndMin = event.end?.let { end ->
