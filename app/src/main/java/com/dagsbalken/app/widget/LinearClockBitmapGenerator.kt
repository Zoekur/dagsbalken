...
object LinearClockBitmapGenerator {
    ...
    fun generate(
        ...
        // Bolt Optimization: Pre-calculate pixelsPerMinute to avoid division in loops
        ...
        // 3. Draw Events
        // Bolt Optimization: Hoist constant calculations outside the loop
        ...
        for (i in events.indices) {
            ...
            if (eventStartPx + eventWidthPx > 0 && eventStartPx < width) {
                ...
                // Bolt Optimization: Omit paint.alpha = 255; next paint.color assignment resets alpha
            }
        }
        ...
        // Bolt Optimization: Hoist constant calculation
