...
object LinearClockBitmapGenerator {
    ...
    fun generate(
        ...
        // Bolt Optimization: Pre-calculate inverse for multiplication (faster than division in loops)
        val pixelsPerMinute = width / windowDurationMinutes.toFloat()
        ...
        // Bolt Optimization: Hoist constant height calculations
