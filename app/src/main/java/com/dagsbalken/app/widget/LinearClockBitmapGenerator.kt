...
object LinearClockBitmapGenerator {
    ...
    fun generate(
        ...
        // Bolt Optimization: Pre-calculate pixelsPerMinute to replace division with multiplication in loops
        ...
        // Bolt Optimization: Hoist constant vertical calculations out of loop
