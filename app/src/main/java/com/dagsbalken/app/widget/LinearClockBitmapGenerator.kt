...
object LinearClockBitmapGenerator {
    ...
    fun generate(
        ...
        // Bolt Optimization: Pre-calculate pixelsPerMinute (multiplication) instead of minutesPerPixel (division)
        // Multiplication is faster than division in drawing loops.
