...
## 2025-12-12 - Standardized Dropdown Interaction
**Learning:** Custom clickable text elements for selection (like the Weather Provider) lack affordance. Users expect standard form controls.
**Action:** Replace custom text+dropdown implementations with `ExposedDropdownMenuBox` to provide clear visual indicators (arrow icon, field border) and standard keyboard navigation.
