Dagsbalken
Visualisering av tid som kognitivt designproblem

Dagsbalken är ett Android‑baserat design‑ och forskningsprojekt som utforskar hur tid kan göras mer kognitivt tillgänglig genom visuell representation. Projektet behandlar tid inte bara som en mätbar enhet, utan som ett upplevt fenomen format av kognition, kontext och vardaglig praktik. Den centrala idén är att representera dagen som en linjär tidsbalk där tidens gång, återstående tid och övergångar mellan aktiviteter synliggörs direkt. Istället för att fokusera på produktivitet betonar Dagsbalken tydlighet, orienterbarhet och självreglering.

Projektet bygger vidare på forskning inom informatik, beteendevetenskap och designforskning och tjänar samtidigt som:

ett designutforskande

ett prototypbaserat forskningsprojekt

ett långsiktigt portfolioartefakt

Project overview

Dagsbalken is an Android‑based design and research project that explores how time can be made more cognitively accessible through visual representation. The project approaches time not merely as a measurable unit, but as an experienced phenomenon shaped by cognition, context, and everyday practice.
...
**TimeLine** is an Android-based design and research project that explores how time can be made more cognitively accessible through visual representation. The project approaches time not merely as a measurable unit, but as an experienced phenomenon shaped by cognition, context, and everyday practice.
